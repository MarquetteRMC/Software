...
struct MD5Sum< ::rtabmap_ros::OdomInfo_<ContainerAllocator> >
{
  ...
  {
    return "edc18a7e4a936ef7e55b956a4970261e";
  }

  static const char* value(const ::rtabmap_ros::OdomInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xedc18a7e4a936ef7ULL;
  static const uint64_t static_value2 = 0xe55b956a4970261eULL;
};

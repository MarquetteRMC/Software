...
struct MD5Sum< ::rtabmap_ros::RGBDImage_<ContainerAllocator> >
{
  ...
  {
    return "a7fa8f34f44b976b3b2dec13c02f9f0e";
  }

  static const char* value(const ::rtabmap_ros::RGBDImage_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa7fa8f34f44b976bULL;
  static const uint64_t static_value2 = 0x3b2dec13c02f9f0eULL;
};

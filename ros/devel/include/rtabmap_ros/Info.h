...
struct MD5Sum< ::rtabmap_ros::Info_<ContainerAllocator> >
{
  ...
  {
    return "f9cc2e215f6cae05161c74d102ffc592";
  }

  static const char* value(const ::rtabmap_ros::Info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf9cc2e215f6cae05ULL;
  static const uint64_t static_value2 = 0x161c74d102ffc592ULL;
};

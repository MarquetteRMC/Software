...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/mars/Software/ros/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/mars/Software/ros/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/mars/Software/ros/install)
...
if(NOT "/home/mars/Software/ros/src/vision_opencv/cv_bridge/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/mars/Software/ros/src/vision_opencv/cv_bridge/include;/usr/include;/usr/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mars/Software/ros/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/usr/lib/x86_64-linux-gnu/libopencv_core.so.3.2.0;/usr/lib/x86_64-linux-gnu/libopencv_imgproc.so.3.2.0;/usr/lib/x86_64-linux-gnu/libopencv_highgui.so.3.2.0")

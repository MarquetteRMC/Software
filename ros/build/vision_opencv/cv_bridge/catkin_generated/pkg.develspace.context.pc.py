...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/home/mars/Software/ros/src/vision_opencv/cv_bridge/include;/usr/include;/usr/include/opencv".split(';') if "/home/mars/Software/ros/src/vision_opencv/cv_bridge/include;/usr/include;/usr/include/opencv" != "" else []
PROJECT_CATKIN_DEPENDS = "rosconsole;sensor_msgs".replace(';', ' ')
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lcv_bridge;/usr/lib/x86_64-linux-gnu/libopencv_core.so.3.2.0;/usr/lib/x86_64-linux-gnu/libopencv_imgproc.so.3.2.0;/usr/lib/x86_64-linux-gnu/libopencv_highgui.so.3.2.0".split(';') if "-lcv_bridge;/usr/lib/x86_64-linux-gnu/libopencv_core.so.3.2.0;/usr/lib/x86_64-linux-gnu/libopencv_imgproc.so.3.2.0;/usr/lib/x86_64-linux-gnu/libopencv_highgui.so.3.2.0" != "" else []
